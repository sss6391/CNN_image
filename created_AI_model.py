...
step_epoch = 300
epoch = 100
model.fit_generator(train_generator, steps_per_epoch=step_epoch, epochs=epoch, validation_data=test_generator
                    , validation_steps=5)
# 5. 모델 평가하기
print("-- Evaluate --")
...
file_name = "a{0:0.2f}s".format(scores[1]*100) + str(step_epoch)+"e"+str(epoch)+".h5"
